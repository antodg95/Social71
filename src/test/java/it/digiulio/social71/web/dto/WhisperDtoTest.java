...
public class WhisperDtoTest {
    ...
    public void testToDto() {
        ...
        assertThat(whisperDTO.getUserId().getId()).isEqualTo(whisper.getUserId().getId());
        assertThat(whisperDTO.getUserId().getUsername()).isEqualTo(whisper.getUserId().getUsername());
        assertThat(whisperDTO.getUserId().getEmail()).isEqualTo(whisper.getUserId().getEmail());
        assertThat(whisperDTO.getUserId().getPassword()).isEqualTo(whisper.getUserId().getPassword());
    }
    ...
    public void testFromDto() {
        ...
        assertThat(whisper1.getUserId().getUsername()).isEqualTo(whisper.getUserId().getUsername());
        assertThat(whisper1.getUserId().getEmail()).isEqualTo(whisper.getUserId().getEmail());
        assertThat(whisper1.getUserId().getDeleteUuid()).isNull();
        assertThat(whisper1.getUserId().getCreatedOn()).isNull();
        assertThat(whisper1.getUserId().getActive()).isNull();
    }
}
