...
public class WebRestControllerAdvice {
    ...
    public ResponseEntity<ExceptionDescriptor<AuthorizationException>> authorizationExceptionResponse(AuthorizationException e) {
        ExceptionDescriptor<AuthorizationException> ret = new ExceptionDescriptor<>(e, HttpStatus.FORBIDDEN);
        return ret.toResponseEntity();
    }
}
